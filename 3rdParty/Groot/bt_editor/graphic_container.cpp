...
void GraphicContainer::createSubtree(Node &root_node, QString subtree_name )
{
    ...
    {
        QMessageBox::warning( nullptr, QString::fromUtf8("\u5B50\u6811\u5DF2\u5B58\u5728"),
                              tr("\u5DF2\u5B58\u5728\u540D\u4E3A [%1] \u7684\u5B50\u6811\u3002\n"
                                 "\u8BF7\u4F7F\u7528\u5176\u4ED6\u540D\u79F0\u3002").arg(subtree_name),
                              QMessageBox::Ok);
        return;
    }
...
void GraphicContainer::onNodeContextMenu(Node &node, const QPointF &)
{
    ...
    //--------------------------------
    auto remove = node_menu->addAction(QString::fromUtf8("\u5220\u9664"));
    ...
    if(auto bt_node = dynamic_cast<BehaviorTreeDataModel*>(node.nodeDataModel()))
    {
        auto subtree = node_menu->addAction(QString::fromUtf8("\u5728\u6B64\u521B\u5EFA\u5B50\u6811"));
...
void GraphicContainer::createMorphSubMenu(QtNodes::Node &node, QMenu* nodeMenu)
{
    ...
    QMenu* morph_submenu = nodeMenu->addMenu(QString::fromUtf8("\u53D8\u6362\u4E3A..."));
...
{
    auto *smart_remove = new QAction(QString::fromUtf8("\u667A\u80FD\u5220\u9664"), node_menu);
...
void GraphicContainer::onConnectionContextMenu(QtNodes::Connection &connection, const QPointF&)
{
    ...
    for(auto category: categories)
    {
        ...
        QMenu* submenu = conn_menu->addMenu(QString::fromUtf8("\u63D2\u5165") + displayName + QString::fromUtf8("\u8282\u70B9") );
